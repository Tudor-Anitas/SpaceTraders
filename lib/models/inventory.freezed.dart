...
abstract class $InventoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String symbol, String name, String description, int units});
}
...
class _$InventoryImpl implements _Inventory {
  ...
  @override
  String toString() {
    return 'Inventory(symbol: $symbol, name: $name, description: $description, units: $units)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, symbol, name, description, units);
...
abstract class _Inventory implements Inventory {
  const factory _Inventory(
      ...
      final String name,
      final String description,
      final int units}) = _$InventoryImpl;
